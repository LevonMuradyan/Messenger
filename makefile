...
bin/$(PROGNAMECLIENT): lib/libclient.a src/client/main.cpp src/client/*.hpp
	@g++ -g3 -std=c++17 src/client/main.cpp -lclient -Llib -L /home/student/poco/poco-1.10.1/lib/Linux/i686/ -lPocoNet -lPocoFoundation -I /home/student/poco/poco-1.10.1/Net/include/ -I /home/student/poco/poco-1.10.1/Foundation/include/ -o $@ 
	@echo "compiling client..."

bin/$(PROGNAMESERVER): lib/libserver.a src/server/main.cpp src/server/*.hpp
	@g++ -g3 -std=c++17 src/server/main.cpp -lserver -Llib -L /home/student/poco/poco-1.10.1/lib/Linux/i686/ -lPocoNet -lPocoFoundation -I /home/student/poco/poco-1.10.1/Net/include/ -I /home/student/poco/poco-1.10.1/Foundation/include/ -o $@ 
...
obj/client/%.o: src/client/%.cpp ./obj/client
	@g++ -g3 -std=c++17 -c $< -o $@ -L /home/student/poco/poco-1.10.1/lib/Linux/i686/ -lPocoNet -lPocoFoundation -I /home/student/poco/poco-1.10.1/Net/include/ -I /home/student/poco/poco-1.10.1/Foundation/include/
